...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginChildPosEx(ImTextureID icon, const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);
    ...
    IMGUI_API bool          BeginChildPos(ImTextureID icon, ImGuiID id, const ImVec2& size_arg, bool border = false, ImGuiWindowFlags extra_flags = 0);
    IMGUI_API void          EndChildPos();
    ...
    IMGUI_API ImU32         GetColorU32(const ImVec4& col, float alpha_mul = 1.0f);                                 // retrieve given color with style alpha applied, packed as a 32-bit value suitable for ImDrawList
	...
	IMGUI_API bool          Tab(const char* ico, const char* label, bool selected, const ImVec2& size_arg, bool tabs, ImGuiButtonFlags flags);
